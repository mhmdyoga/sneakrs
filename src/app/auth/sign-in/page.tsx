                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button
                    ...
                    className={isSubmitting
                      ? 'bg-slate-400 p-4 inline-block shrink-0 border border-slate-400 text-gray-300 rounded-md'
                      : 'inline-block shrink-0 border border-yellow-600 bg-yellow-600 px-12 py-3 text-sm font-bold text-slate-50 transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 rounded-md'
                    }
                  > 
